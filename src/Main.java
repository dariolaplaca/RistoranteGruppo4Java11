...
public class Main {
    public static void main(String[] args) {
        ...
        Course veganSecondCourse = new Seconds("Spiced Carrot Falafel", "Spiced Carrot Falafel, served with mixed vegetables", false, true, 400, 200, 15.99, MenuTypeEnum.VEGAN_MENU, Set.of(AllergensEnum.LENTIL));
