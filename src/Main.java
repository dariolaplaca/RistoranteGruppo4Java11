...
public class Main {
    public static void main(String[] args) {
        ...
        Course wagyu = new Seconds("Wagyu", "Luxurious premium cut cooked to perfection, served with creamy mashed potatoes and steamed green beans.", 30, 400, 18.99, MenuTypeEnum.MEAT_MENU, Set.of(AllergensEnum.DAIRY));
        Course kangarooSausage = new Seconds("Kangaroo Sausage", "Unique and flavorful sausage made with lean, tender kangaroo meat, served with sauerkraut and homemade mustard.", 25, 750, 20.99, MenuTypeEnum.MEAT_MENU, Set.of(AllergensEnum.MUSTARD));
        Course meatRolls = new Seconds("Meat Rolls", "Hearty and delicious appetizer with seasoned ground beef wrapped in crispy pastry, served with tomato dipping sauce.", 15, 300, 12.59, MenuTypeEnum.MEAT_MENU, Set.of(AllergensEnum.CEREALS_CONTAINING_GLUTEN));
